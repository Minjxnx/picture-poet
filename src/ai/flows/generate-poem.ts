...
const GeneratePoemInputSchema = z.object({
  ...
  poetryStyle: z.string().describe('The style of poetry to use, e.g., haiku, sonnet, free verse.'),
  imageAnalysis: z.string().describe('The AI-generated analysis of the image content and themes.'),
});
...
const poemPrompt = ai.definePrompt({
  ...
  prompt: `You are a skilled poet who can create poems in various styles. 

  Based on the following image analysis and the user's selected poetry style, write a poem.
